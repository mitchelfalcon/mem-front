...
import { KPIS, ENDEMIC_CHANNEL, TRENDS, ZONE_SHARE, type KpiEntry } from "../data/estadisticas";

const TONE: Record<KpiEntry["tone"], { text: string; bg: string; icon: typeof Activity }> = {
  blue: { text: "text-blue-600", bg: "bg-blue-50", icon: Activity },
              ...
              {chartsReady ? (
                <ResponsiveContainer width="100%" height="100%">
                  <ComposedChart data={ENDEMIC_CHANNEL} margin={{ top: 8, right: 8, left: -18, bottom: 0 }}>
                    ...
                    <Line type="monotone" dataKey="casos" name="Casos" stroke="#2563eb" strokeWidth={3} dot={{ r: 2 }} />
                  </ComposedChart>
                </ResponsiveContainer>
              ) : (
                <ChartSkeleton />
              ...
              {chartsReady ? (
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={TRENDS} margin={{ top: 8, right: 8, left: -22, bottom: 0 }}>
                    ...
                    <Area type="monotone" dataKey="ingresos" name="Ingresos" stroke="#2563eb" strokeWidth={2} fill="url(#gIng)" />
                    <Area type="monotone" dataKey="resueltos" name="Resueltos" stroke="#7c3aed" strokeWidth={2} fill="url(#gRes)" />
                  </AreaChart>
                </ResponsiveContainer>
              ) : (
                <ChartSkeleton />
